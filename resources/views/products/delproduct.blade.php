    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('del.product') }}">
                    @csrf
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="nombre" class="block mt-1 w-full" type="text" disabled name="nombre" :value="$products->Nombre" required autofocus autocomplete="nombre" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="existencia" class="block mt-1 w-full" type="text" disabled name="existencia" :value="$products->Existencias" required autocomplete="existencia" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="precio" class="block mt-1 w-full" type="text" disabled name="precio" :value="$products->Precio" required autocomplete="precio" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="precio_p" class="block mt-1 w-full" type="text" disabled name="precio_p" :value="$products->PrecioCompra" required autocomplete="precio_p" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="codigo" class="block mt-1 w-full" type="text" disabled name="codigo" :value="$products->Codigo" required autocomplete="codigo" />
